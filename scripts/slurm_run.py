...
Usage:
    python scripts/slurm_run.py --dataset  --anatomy v1
    python scripts/slurm_run.py --dataset  --anatomy v1 --dry-run
...
python ./scripts/slurm_run.py --dataset  --anatomy v1 --paths hyak --base-dir /gscratch/portia/eabe/data/Johnson_lab//session11
