...
def test_stac_forwards_tolerance_defaults_when_keys_absent():
    ...
    StacCore defaults (1e-8 / 1e-10) when an anatomy config lacks
    JAXLS_GRADIENT_TOLERANCE / JAXLS_PARAMETER_TOLERANCE.
    ...
    # Sanity: the fixture config must genuinely lack the two keys, or this
